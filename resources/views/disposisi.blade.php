        ...
        <table style="border:1px solid #000; width:100%;">
            <tbody>
                <tr>
                    ...
                    <td width="20%">{{ request('asal_surat') ?? '' }}</td>
                    <td width="20%">Diterima Tanggal</td>
                    <td width="20%">{{ \Carbon\Carbon::now()->isoFormat('D MMMM Y') }}</td>
                    <td width="20%"></td>
                </tr>
                <tr>
                    <td width="20%" colspan="2"></td>
                    <td width="20%">No Agenda</td>
                    <td width="20%">{{request('no_agenda')}}</td>
                    <td width="20%"></td>
                </tr>
                <tr>
                    <td width="20%">No. Surat</td>
                    <td width="20%">{{ request('nomor_surat') }}</td>
                ...
                <tr style="height:3rem;">
                    ...
                    <td width="20%">{{ \Carbon\Carbon::parse(request('tanggal_surat'))->isoFormat('DD MMMM YYYY') }}
                    </td>
                    <td width="20%" style="padding-left:10px"><input type="checkbox"> Sangat Segera</td>
                    <td width="20%" style="padding-left:10px"><input type="checkbox"> Segera</td>
                    <td width="20%" style="padding-left:10px"><input type="checkbox"> Rahasia</td>
                </tr>
                <tr style="height:3rem;">
                    <td width="20%">Hal</td>
                    <td width="20%" colspan="4">{{ request('perihal') }}</td>
                </tr>
                <tr>
